function findcalls_v5_EzEl(wd,fs,varargin)
...
mergethresh = 10e-3; % in s : any windows less than mergethresh (5ms) apart will be combined
rmsthresh=0.02;%has to be adapted to recording quality : is it loud enough premerge?
